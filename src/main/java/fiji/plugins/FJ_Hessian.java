...
public class FJ_Hessian implements PlugIn, WindowListener {
	...
	public static void execute(ImagePlus impe, boolean largeste, boolean middlee,boolean smalleste, boolean absolutee, String scalee)
	{
		(new FJHessian()).run(impe, largeste, middlee,smalleste, absolutee, scalee);
	}
