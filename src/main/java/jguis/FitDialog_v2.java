...
public class FitDialog_v2 implements NLLSfitinterface_v2,TableDialogListener{
	...
	public boolean showoptions(double[] params,int[] fixes){
		...
		Object[][] tabledata=new Object[nparams+4][3];
		...
		tabledata[nparams+2][0]="Iterations";
		tabledata[nparams+2][1]=new Integer(iterations);
		tabledata[nparams+3][0]="Chi Squared";
		tabledata[nparams+3][1]=new Double(c2);
