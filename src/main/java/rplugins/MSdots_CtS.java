...
public class MSdots_CtS implements PlugIn {
...
int combo = 1;		//back to 1
while(combo<=5){  	//back to 6
	int duplicates= 0;
	while(duplicates<50){  //back to 10
...
String title = "combo_"+combo+"_dup_"+duplicates; 
IJ.run("MSsim StackSave");

try{thisThread.sleep(100L);
...
//Class dotclass = MSdots_CtS.getClass();
//dotclass.wait(10);
...
IJ.run("MSmacroRLA sim");

//thisThread.sleep(100L);
/*
//dotclass.wait(10);
IJ.log("test");
k=0;
