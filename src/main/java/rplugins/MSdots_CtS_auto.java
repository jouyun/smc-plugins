...
public class MSdots_CtS_auto implements PlugIn {
...
String title = "Red_"+percR+"_Green_"+percG+"_Blue_"+percB+"_numCells_"+numCells+"__dup_"+duplicates;
imp5.setTitle(title);
