...
public class TEST_Batch_Delete_Slices_LIM 	extends JPanel implements PlugIn , ActionListener{
   ...
   // CalcDistance CalcDist = new CalcDistance();
    ...
    public Batch_Delete_Slices_LIM() {
	...
	rangeEndText.setText("");
        ...
        //Handle process button action
        	...
        	try{
           		 int returnVal = fc.showOpenDialog(Batch_Delete_Slices_LIM.this);
...
//Function to delete slices
  public void deleteSlices(){
    ...
    private static void createAndShowGUI() {
        ...
        JFrame frame = new JFrame("Batch Delete Slices");
        frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);

        //Add content to the window.
        frame.add(new Batch_Delete_Slices_LIM());
    ...
    public void run(String arg) {
		...
		Batch_Delete_Slices_LIM.mainrun();
	}
}
