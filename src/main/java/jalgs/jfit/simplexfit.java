...
public class simplexfit{
	...
	public simplexfit(NLLSfitinterface fitinterface,double toler1,int maxiter1,int miniter1,double simplex_size1){
	...
	public simplexfit(NLLSfitinterface fitinterface,int maxiter1,int miniter1){
		fitclass=fitinterface;
		maxiter=maxiter1;
		miniter=miniter1;
		toler=0.0001;
	...
	public simplexfit(NLLSfitinterface fitinterface,double toler1){
		fitclass=fitinterface;
		toler=toler1;
		maxiter=100;
		miniter=1;
	...
	public simplexfit(NLLSfitinterface fitinterface){
		fitclass=fitinterface;
		toler=0.0001;
		maxiter=100;
		miniter=1;
